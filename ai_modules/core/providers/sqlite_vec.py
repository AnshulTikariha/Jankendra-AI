"""sqlite-vec vector store adapter stub."""
...
class SQLiteVecStore:
    """Development vector store placeholder backed by sqlite-vec."""

    def __init__(self, *, database_url: str) -> None:
        self.database_url = database_url

    def upsert(self, collection: str, records: Sequence[VectorRecord]) -> None:
        raise NotImplementedError("sqlite-vec provider implementation is pending")
